...
MEDIALIBRE = "/media/libre/TESTtpcyn"
DATADIR = "./data"
TESTINDIR = MEDIALIBRE + "/imagenes_a_testear"
CATEDRADIR = MEDIALIBRE + "/resultados_catedra"
ALUMNOSDIR = MEDIALIBRE + "/resultados_nuestros"
TP2ALU = "../build/tp2"
TP2CAT = "./tp2catedra"
DIFF = "../build/bmpdiff"
DIFFFLAGS = ""
...
corridas = [
    {'filtro': 'tresColores', 'tolerancia': 5, 'params': ''},
    {'filtro': 'efectoBayer', 'tolerancia': 5, 'params': ''},
    {'filtro': 'cambiaColor', 'tolerancia': 5, 'params': '255 255 255 0 0 0 100'},
    {'filtro': 'edgeSobel', 'tolerancia': 5, 'params': ''}
]
